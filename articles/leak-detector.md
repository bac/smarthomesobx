---
layout: page
title: "Smart Home Tips: Avoiding Water Damage from Plumbing Leaks"
permalink: /articles/leak-detector/
---

*By Brad Crittenden —
[info@SmartHomesOBX.com](mailto:info@SmartHomesOBX.com)*

## Potential for damage

Outer Banks property owners are all keenly aware of the risks of
flooding and storm damage posed by living on a barrier island. We
do what we can to protect ourselves and our property to mitigate
those risks.

Our cottages face another persistent risk of water damage — the
...
absentee homeowners, but to proactively stop the flow of the
damaging water as soon as it is detected.
...
While the statistics show the risk of leaks from plumbing and
appliances is substantial, there are now tools that can help reduce
the risk, prevent the damage, and give the homeowner real peace of
mind.

This article discusses three tools that can be used together in a
home to achieve the goal of detecting water leaks and taking
action, often with no human intervention required.
...
[diagram]: {{ "/assets/images/leak-detection-diagram.png" | relative_url }}

### Leak detectors

The first tool is a simple leak detector: a small (2⅜" x 2⅜" x
1"), inexpensive, battery-powered device that can be placed around
the home in locations prone to leaking. These locations include
sinks, toilets, dishwashers, washing machines, refrigerators,
...
A five-bedroom home with five bathrooms would need about a dozen
...
shuts automatically when one of the leak detectors senses water,
and it can also be controlled via a smartphone app.
...
pipe and uses ultrasonic sensors to measure flow — the same
technology used in some public water meters, including the ones
recently installed by Nags Head.

## Installation

All of the components described above can be installed by a
